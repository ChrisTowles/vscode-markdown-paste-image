export class Constants {
  ...
  public static vsCommandName = 'extension.markdownPasteImage'; // match the command in package.json
  public static ConfigurationName = 'markdownPasteImage'; // match the command in package.json
